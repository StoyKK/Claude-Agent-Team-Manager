...
- [ ] **LOG-01**: Centralized logger facade service that integrates with @tauri-apps/plugin-log when running in Tauri, falls back to console when running in browser-only mode (pnpm dev)
